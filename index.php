...
<body style="background-color:#212529;">
    ...
    <div id="container">
            ...
            <div class="row">
                <div class="col" style="margin-left: 5%;">
                    <br><br>&nbsp;<p class="zoomfont"
                        style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center; color:white;"><b>Welcome to <br>
                        The Sparks Bank!</b></p>
                </div>
        ...
        <img src="statics/bg.png" alt="" style="width:100%; height:70%; position:absolute; z-index:-1">
        ...
        <center style="margin:60px 0px 20px 0px;">
            <div class="container"
                ...
                <h1 style="text-shadow:2px 2px 2px gray; color:black;"><b>Our Awesome Facilities</b></h1>
